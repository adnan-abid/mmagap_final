...
ActiveRecord::Schema.define(:version => 20140326071200) do
  ...
  create_table "paypal_gateways", :force => true do |t|
  ...
  create_table "settings", :force => true do |t|
    ...
    t.datetime "created_at",           :null => false
    t.datetime "updated_at",           :null => false
    t.float    "subscriptions_price"
    t.string   "subscriptions_time"
  end
